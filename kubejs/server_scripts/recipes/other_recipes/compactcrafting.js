    ...
    */
    const recipes = [
        ...
        },
        {
            recipesize:7,
            layer:[
               compactcrafting(7,[" "," "," "," "," "," "," "],[" ","A","A","A","A","A"," "],[" ","A","C","C","C","A"," "],[" ","A","C","A","C","A"," "],[" ","A","C","C","C","A"," "],[" ","A","A","A","A","A"," "],[" "," "," "," "," "," "," "]),
               compactcrafting(7,[" "," "," ","B"," "," "," "],[" "," "," ","B"," "," "," "],[" "," ","A","A","A"," "," "],["B","B","A","C","A","B","B"],[" "," ","A","A","A"," "," "],[" "," "," ","B"," "," "," "],[" "," "," ","B"," "," "," "]),
               compactcrafting(7,[" "," "," ","B"," "," "," "],[" "," "," "," "," "," "," "],[" "," "," "," "," "," "," "],["B"," "," "," "," "," ","B"],[" "," "," "," "," "," "," "],[" "," "," "," "," "," "," "],[" "," "," ","B"," "," "," "]),
               compactcrafting(7,[" "," "," "," "," "," "," "],[" "," "," "," "," "," "," "],[" "," "," "," "," "," "," "],[" "," "," "," "," "," "," "],[" "," "," "," "," "," "," "],[" "," "," "," "," "," "," "],[" "," "," "," "," "," "," "]),
               compactcrafting(7,[" "," "," ","B"," "," "," "],[" "," "," "," "," "," "," "],[" "," "," "," "," "," "," "],["B"," "," "," "," "," ","B"],[" "," "," "," "," "," "," "],[" "," "," "," "," "," "," "],[" "," "," ","B"," "," "," "]),
               compactcrafting(7,[" "," "," ","B"," "," "," "],[" "," "," ","B"," "," "," "],[" "," ","A","A","A"," "," "],["B","B","A","C","A","B","B"],[" "," ","A","A","A"," "," "],[" "," "," ","B"," "," "," "],[" "," "," ","B"," "," "," "]),
               compactcrafting(7,[" "," "," "," "," "," "," "],[" ","A","A","A","A","A"," "],[" ","A","C","C","C","A"," "],[" ","A","C","A","C","A"," "],[" ","A","C","C","C","A"," "],[" ","A","A","A","A","A"," "],[" "," "," "," "," "," "," "]),
            ...
            catalyst:'elementalcraft:swift_alloy_ingot',
            components:{
               "A":component('ars_nouveau:sourcestone'),
               "B":component('kubejs:polished_gold_block'),
               "C":component('ars_nouveau:source_gem_block')
            },
